...
The coordinates are provided as geometry files suitable for use in atomistic simulations (e.g., DFT calculations in VASP/ASE workflows).  
(Refer to folder structure for exact formats and naming.)
...
E-mail: biswarup@iiti.ac.in :contentReference[oaicite:3]{index=3}
